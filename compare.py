...
# BUILD1=build BUILD2=build-original find $BUILD1 -type f | while read FILE1; do echo $FILE1 ; FILE2=`echo $FILE1 |sed "s/$BUILD1/$BUILD2/"` ; python compare.py $FILE1 $FILE2; done  # noqa: E501
